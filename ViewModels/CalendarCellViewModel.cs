...
public sealed class CalendarCellViewModel : ViewModelBase
{
    ...
    public string ExpectedCursorText => _dayData != null ? $"{(int)_dayData.ExpectedQuotaCursor}%" : string.Empty;
    public string ExpectedOtherText => _dayData != null ? $"{(int)_dayData.ExpectedQuotaOther}%" : string.Empty;
    public string ProjectedCursorText => _dayData?.ProjectedQuotaCursor is double value ? $"{(int)Math.Round(value, MidpointRounding.AwayFromZero)}%" : string.Empty;
    public string ProjectedOtherText => _dayData?.ProjectedQuotaOther is double value ? $"{(int)Math.Round(value, MidpointRounding.AwayFromZero)}%" : string.Empty;
